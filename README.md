...
本项目选择赛题**方向 3：材料科学文献驱动的科学发现智能体**。

系统先完成方向 3 的基础任务：自主检索与筛选文献、抽取结构化知识、识别 Research Gap，并生成带文献溯源的调研结果；在进阶任务中选择**构效关系发现**路线（Route A），利用论文配对、CSP 知识和候选搜索生成可证伪的材料-结构-性质假设。
